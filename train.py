...
## Parser 생성하기
# parser : dynamic 하게 학습을 하는 설정값들을 관리하기 위해서(shell terminal과 같은)
...
args = parser.parse_args()  # 진짜 값들로 parsing 해줌
...
## Tensorbard 를 사용하기 위한 summaryWriter 설정
# WandB의 훅을 정의하는 부분이겠지??
...
if mode == 'train':
    ...
    for epoch in range(st_epoch + 1, num_epoch + 1):
        ...
        for batch, data in enumerate(loader_train, 1):
            ...
            # Tensorboard 저장하기(numpy 형태로 tensorboard에 저장해야하나...)
        ...
        # validation 부분
        with torch.no_grad(): # back propagation 사전에 막기 위함..?
            net.eval()  # validation이니까
            loss_arr = []
