...
class UNet(mm.Module):
    def __init__(self):
        ...
        def CBR2d(in_channels, out_channels, kernel_size=3, stride=1, padding=1, bias=True):
            ...
            cbr = nn.Sequential(*layers)            # *은 왜지??

            return cbr

        # contrasting path
        # encoder part 구현(화살표를 구현하면 됨)
        self.enc1_1 = CBR2d(in_channels=1, out_channels=64) # 이부분은 default로 지정해줌-> kernel_size=3, stride=1, padding=1, bias=True
